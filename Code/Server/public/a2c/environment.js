class Environment
{
	...
	step = async function(action_index ) {//,state,state_scaled,incremental){
		...
		this.reward = (- (this.sonic_state  - this.last_distance) / 5) - 0.5
